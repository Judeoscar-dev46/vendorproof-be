...
exports.analyseTransferScreenshot = analyseTransferScreenshot;
const sdk_1 = __importDefault(require("@anthropic-ai/sdk"));
const env_1 = require("../config/env");
const client = new sdk_1.default({ apiKey: env_1.env.ANTHROPIC_API_KEY });
async function analyseTransferScreenshot(base64Screenshot, mediaType, claimedDetails) {
...
//# sourceMappingURL=transferScreenshotAnalyser.js.map