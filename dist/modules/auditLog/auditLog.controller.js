...
const AuditService = __importStar(require("./auditLog.service"));
...
async function getAuditLogs(req, res, next) {
    try {
        ...
        if (['admin', 'officer', 'viewer'].includes(role)) {
            ...
            console.log(userId);
            const result = await AuditService.getUserAuditLogs(userId, role, parsed.data.page, parsed.data.limit);
            return ok(res, result);
        }
    }
    catch (err) {
